                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Profesores Registrados" href="all-professors.php"><span class="mini-sub-pro">Registrados</span></a></li>
                                <li><a title="Add Professor" href="add-professor.html"><span class="mini-sub-pro">Agregar admin</span></a></li>
                            
                                <li><a title="Perfil Profesor" href="perfil-profesor.php"><span class="mini-sub-pro">Perfil</span></a></li>
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Profesores <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="edit-professor.php">Editar</a>
                                                </li>
                                                <li><a href="perfil-profesor.php">Perfil</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Examenes <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demodepart" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="edit-department.php">Editar</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Tablas<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="Tablesmob" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="data-table.html">Solicitudes</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
