            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="all-professors.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Profesores</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Editar Profesor" href="edit-professor.php"><span class="mini-sub-pro">Editar</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Editar Estudiantes" href="edit-student.php"><span class="mini-sub-pro">Editar</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Editar Examen" href="edit-department.php"><span class="mini-sub-pro">Editar</span></a></li>
                            </ul>
                        </li>
                        <li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="../perfil.php"><span class="edu-icon edu-user-rounded author-log-ic"></span>Perfil</a>
                                                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Estudiantes <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="edit-student.php">Editar</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-dtl">
                                <h2><?php echo $mostrar['TestName']?></h2>
                                <p class="dp-ag"><b>Fecha: </b><?php echo $mostrar['Fecha']?></p>
                                <p class="dp"><?php echo $mostrar['HInicio']?></p>
                                <a href= "modificar_examen.php?id=<?php echo $mostrar['IDExamen']?>"> Modificar</a>
