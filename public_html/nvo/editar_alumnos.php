...
<?php
		$con = mysqli_connect("127.0.0.1:3306","admin_dorito","1q2w3e","admin_examendb") or die(mysql_error());
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Professor Profile" href="professor-profile.html"><span class="mini-sub-pro">Perfil</span></a></li>
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Profesores <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="../admin_signup.php">Add Professor</a>
                                                </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="lid" type="text" class="form-control" value="<?php echo $mostrar['ID']?>" id ="lid">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="name" type="text" class="form-control" value="<?php echo $mostrar['Nombre']?> id = "name">
                                                            </div>
                                                            <div class="form-group">
