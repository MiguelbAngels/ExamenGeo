...
echo "<h2 class=head1> Seleccione un exámen para ver la información:</h2>";
echo "</br></br>"; 
...
{
	echo "<tr class='success' ><td align=center class='text-danger'><a  href=resultados_alumnos.php?idex=$row[0]><font  size=4 >$row[1]</font></a>";
}
echo "</table>";
?>
</body>
